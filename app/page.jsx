...
const Home = () => {
  ...
  <span className="block bg-transparent">Software Developer</span>
  <h1 className="h1 mb-6">
    Hello I'm <br />
    <span className="text-accent">Abdullahi K</span>
  </h1>
  <p className="max-w-[500px] mb-9 text-white/80">
    I excel at crafting elegant experiences and am proficient in various programming languages and technologies.
  </p>
</div>
