      ...
      <div className="container mx-auto">
        ...
        >
         {service.map((service, index)=>{
          return (
            <div key={index} className='flex-1 flexflex-col  justify-center gap-6 group'>
            ...
            <h2 className=' text-[42px]font-bold leading-none text-white group-hover:bg-accentn group-hover:text-accent transition-all duration-500 '>{service.title}</h2>
